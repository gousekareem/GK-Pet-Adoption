...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        // If backend sends a string, show it; if object, show .message or .error
        const backendMsg = typeof error.response.data === 'string'
          ? error.response.data
          : error.response.data?.message || error.response.data?.error || 'Server error. Please try again later.';
