  ...
  return (
    <div className="home">
      ...
      <div className="hero-section">
        <div className="hero-text">
          <h1 className="hero-title">
            Find Your Perfect Friend <span className="highlight-text">Furry companion</span>
          </h1>
          <p className="hero-description">
            Browse thousands of pets from trusted shelters, and find your new best friend today!
          </p>
          <div className="cta-buttons">
            <Link to="/pets" className="cta-button primary">Find your friend</Link>
            <Link to="/shelters" className="cta-button secondary">Shelter directory</Link>
          </div>
        </div>
      ...
      <div className="cta-section">
        ...
        <p className="cta-description">Start your journey and discover the perfect pet for you.</p>
        <Link to="/pets" className="cta-button primary">Explore Available Pets <img src={pawPrintImage} alt="paw icon" className="cta-icon" /></Link>
      </div>
    </div>
  );
}
