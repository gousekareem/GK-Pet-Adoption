      ...
      {selectedPet && (
        <div className="modal-overlay">
          <div className="modal">
            ...
            <p>📞 Contact: <strong>+91 83282 72472</strong></p>
            <p>📍 Location: <strong>Benz Circle, Vijayawada</strong></p>
            <p>🐾 Please visit the adoption center to complete the Registration.</p>
